        ...
        .then(data => {
            ...
            popup.innerHTML = `
                <div class="text-center py-6">
                    ...
                    <h3 class="text-2xl font-bold text-blue-600 mb-2">Thank You!</h3>
                    <p class="text-gray-600 mb-6">Your feedback has been submitted successfully.</p>
                    <button id="close-success" class="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-colors">Close</button>
                </div>
            `;
